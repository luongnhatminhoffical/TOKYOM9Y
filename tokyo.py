...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---SPAM SMS by NhatMinh       ZALO:0564833795         BẢN QUYỀN by:NhatMinh'
        banner = '''\n./\__  _\/\  __`\/\ \/\ \ /\ \  /\ \/\  __`\    
\/_/\ \/\ \ \/\ \ \ \/'/'\ `\`\\/'/\ \ \/\ \   
   \ \ \ \ \ \ \ \ \ , <  `\ `\ /'  \ \ \ \ \  
    \ \ \ \ \ \_\ \ \ \\`\  `\ \ \   \ \ \_\ \ 
    ...
    def run(self):
        while True:
            ...
            if self.phone != '0564833795':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0365423960':
                print(self.format_print("!", "SỐ ĐIỆN THOẠI ADMIN ĐẸP TRAI SPAM CC"))
            time.sleep(3)
